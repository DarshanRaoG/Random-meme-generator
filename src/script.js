...
function clearAll(idnty) {
  let divElement = document.getElementById(idnty);
  while (divElement.firstChild) {
     divElement.removeChild(divElement.firstChild);
  }
  // or you can do divElement.innerHTML='';
}
...
function showMeme() {
  ...
  attr.value=randomMemeUrl;
  anchor.setAttributeNode(attr);
  document.querySelector('#meme').appendChild(anchor);
}
...
function showJoke() {
  ...
  document.querySelector('#joke').appendChild(para);
}
...
function showQuote() {
  ...
  para1.textContent = randomQuote.quote;
  document.querySelector('#quote').appendChild(para1);

  const para2 = document.createElement("p");
  para2.textContent = "-" + randomQuote.author;
  document.querySelector('#quote').appendChild(para2);
}
...
function showRiddle() {
  ...
  const para = document.createElement("p");
  para.textContent = randomRiddle.question;
  document.querySelector('#riddle').appendChild(para);
...
function revealAnswers() {
  if(document.querySelector('#riddle').children.length === 0)
    alert('No riddle!');
  else if(document.querySelector('#riddle').children.length > 1){
    alert('Answer already revealed!');
  }
  else{
    const para1 = document.createElement("p");
    const temp = document.querySelector('#riddle').firstChild.textContent;

    let t;
    while(((t=getRandomData("riddles")).question !== temp)){}

    para1.textContent = "\n-" + t.answer;
    document.querySelector('#riddle').appendChild(para1);
  }
}
